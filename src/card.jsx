...
function Card({ country, setCountry }) {
    ...
    return (
        <Link to='/detail' className="w-fit m-auto">
        <div className="bg-white dark:bg-[#2b3945] shadow-[0_0_10px_2px_#b7bec4] dark:shadow-[0_0_10px_2px_#172129] min-w-[16rem] w-[18rem] h-[24rem] m-auto rounded-lg text-[#111517] dark:text-white hover:translate-y-[-1rem] duration-200 relative" onClick={() => {setCountry(country)}}>
